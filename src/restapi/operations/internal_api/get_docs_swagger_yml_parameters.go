...
// NewGetDocsSwaggerYmlParams creates a new GetDocsSwaggerYmlParams object
// with the default values initialized.
func NewGetDocsSwaggerYmlParams() GetDocsSwaggerYmlParams {
	var ()
	return GetDocsSwaggerYmlParams{}
}

// GetDocsSwaggerYmlParams contains all the bound params for the get docs swagger yml operation
