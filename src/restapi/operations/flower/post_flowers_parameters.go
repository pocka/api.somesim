...
// NewPostFlowersParams creates a new PostFlowersParams object
// with the default values initialized.
func NewPostFlowersParams() PostFlowersParams {
	var ()
	return PostFlowersParams{}
}

// PostFlowersParams contains all the bound params for the post flowers operation
