...
func (o *PutFlowersNameURL) Build() (*url.URL, error) {
	...
	if name != "" {
		...
		return nil, errors.New("Name is required on PutFlowersNameURL")
	}
...
func (o *PutFlowersNameURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutFlowersNameURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutFlowersNameURL")
	}
