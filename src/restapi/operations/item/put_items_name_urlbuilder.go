...
func (o *PutItemsNameURL) Build() (*url.URL, error) {
	...
	if name != "" {
		...
		return nil, errors.New("Name is required on PutItemsNameURL")
	}
...
func (o *PutItemsNameURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutItemsNameURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutItemsNameURL")
	}
