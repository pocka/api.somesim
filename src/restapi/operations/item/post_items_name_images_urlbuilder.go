...
func (o *PostItemsNameImagesURL) WithBasePath(bp string) *PostItemsNameImagesURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostItemsNameImagesURL) Build() (*url.URL, error) {
	...
	if name != "" {
		...
		return nil, errors.New("Name is required on PostItemsNameImagesURL")
	}
...
func (o *PostItemsNameImagesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostItemsNameImagesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostItemsNameImagesURL")
	}
